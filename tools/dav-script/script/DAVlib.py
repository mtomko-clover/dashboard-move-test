...
def open_jira(developer,file_name, status_string, DAV):
    """
    Open a Jira:
    -----------
...
def query_p801(query, db_host, shard_user, shard_PWD):
    """
    Query p801:
    -----------
...
def auto_credit(last_time, db_host, p801_user, p801_pass, jira_host, jira_user, jira_pass):
    """
    ...
    uuid_tuple = query_p801(changed_developer_accts, db_host, p801_user, p801_pass)
    ...
    if len(stringified_uuids) > 2:
        credit(stringified_uuids, p801_user, p801_pass, jira_host, jira_user, jira_pass)
    else:
...
def credit(uuids, db_host, p801_user, p801_pass, jira_host, jira_user, jira_pass):
    """
    ...
    developer_output = query_p801(query, db_host, p801_user, p801_pass)
...
# in prelaunch3 script, this was the menu, pick a choice 1-4 
# def print_menu():
