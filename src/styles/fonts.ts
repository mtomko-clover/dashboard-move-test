...
export const fontDeclarations = css`
  ...
  @font-face {
    ...
    src: local("Maison Mono Regular"), local("Maison-Mono-Regular"),
      url("/fonts/Maison-Mono-Regular.otf") format("opentype");
    font-weight: 400;
    font-style: normal;
  }
  ...
  @font-face {
    font-family: "Maison Mono";
    src: local("Maison Mono Italic"), local("Maison-Mono-Italic"),
      url("/fonts/Maison-Mono-Italic.otf") format("opentype");
    font-weight: 400;
    font-style: italic;
  }
  ...
  @font-face {
    font-family: "Maison Mono";
    src: local("Maison Mono Light"), local("Maison-Mono-Light"),
      url("/fonts/Maison-Mono-Light.otf") format("opentype");
    font-weight: 300;
    font-style: normal;
  }
  ...
  @font-face {
    font-family: "Maison Mono";
    src: local("Maison Mono Bold"), local("Maison-Mono-Bold"),
      url("/fonts/Maison-Mono-Bold.otf") format("opentype");
    font-weight: 700;
    font-style: normal;
  }
`